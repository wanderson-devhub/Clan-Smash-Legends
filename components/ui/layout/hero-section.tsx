    ...
    <section id="home" className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10">
        <div className="relative mb-8">
          <Image
            ...
            className="opacity-90 w-full h-[300px] sm:h-[400px] object-cover rounded-lg shadow-2xl"
          />
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-8 flex flex-col items-center">
            <h1 className="text-2xl sm:text-4xl font-bold text-white mb-2 sm:mb-4 px-2">
              Bem-vindo ao Clã TeenWolf
            </h1>
            <p className="text-sm sm:text-lg text-white mb-4 sm:mb-6 px-2">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3 w-full max-w-md mx-auto px-2">
              ...
              >
                <button
                  disabled={isLoading}
                  className="w-full disabled:opacity-70 transform skew-x-12 bg-gradient-to-b from-[#168AE9] to-[#31A4FD] text-white px-6 sm:px-8 py-2 sm:py-3 rounded hover:opacity-90 transition-opacity"
                >
              ...
              <button
                ...
                className="w-full sm:w-auto transform skew-x-12 bg-gradient-to-b from-[#4663B9] to-[#4E69C2] text-white px-6 sm:px-8 py-2 sm:py-3 rounded hover:opacity-90 transition-opacity"
              >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 animate-fadeIn p-4">
          <div className="bg-[#1D1E4D] p-6 sm:p-8 rounded-lg max-w-md w-full mx-auto animate-slideIn">
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center gap-2 bg-[#2A2B5D] p-2 rounded">
                <span className="text-white text-sm">ggeuy5adqudk</span>
                <button
                  onClick={() => {
                    handleCopyId();
                    toast({
